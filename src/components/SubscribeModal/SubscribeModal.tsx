...
const SubscribeModal = ({ onClose }: { onClose: () => void }) => {
	...
	return (
		<div className="fixed top-0 left-0 w-full h-full z-50 flex items-center justify-center" onClick={onClose}>
			<div
				...
				<form className="mt-[8px] lg:mt-[25px] flex flex-col gap-[15px] lg:gap-[25px]">
